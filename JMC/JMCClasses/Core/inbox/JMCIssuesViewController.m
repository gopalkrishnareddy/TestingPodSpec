...
- (id)initWithStyle:(UITableViewStyle)style {
    ...
    if (self) {
        ...
        self.title = JMCLocalizedString(@"Your Tickets", @"Title of list of previous messages");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.detailsLabel.text = [NSString stringWithFormat:@"%@%@",issue.key, (issue.status ? [NSString stringWithFormat:@"  -  (%@)",issue.status] : @"")];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (sentStatus != JMCSentStatusSuccess) {
        ...
        detailViewController.title = issue.key;
